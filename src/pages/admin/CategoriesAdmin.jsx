...
const CategoriesAdmin = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) => {
      toast({
        title: "Hata",
        description: `Kategori oluşturulurken bir sorun oluştu: ${
  ...
  const updateMutation = useMutation({
    ...
    onError: (err) => {
      toast({
        title: "Hata",
        description: `Kategori güncellenirken bir sorun oluştu: ${
          err.response?.data?.message || err.message
        }`,
        variant: "destructive",
      });
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                {currentCategory
                  ? "Seçili kategorinin bilgilerini güncelleyin."
                  : "Yeni bir kategori oluşturmak için bilgileri doldurun."}
              </DialogDescription>
            </DialogHeader>
      ...
      {categories.length > 0 ? (
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="py-3 px-4 text-sm font-semibold uppercase tracking-wider">
                ID
              </TableHead>
              <TableHead
              ...
              <TableHead
                lassName="py-3 px-4 text-sm font-semibold uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:hover:text-gray-300"
              ...
              <TableHead className="py-3 px-4 text-sm font-semibold uppercase tracking-wider text-right">
                İşlemler
              </TableHead>
            </TableRow>
          </TableHeader>
