...
import ScoreWeightsPanel from "@/components/admin/ScoreWeightsPanel";
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Skeleton className="w-full h-[300px] rounded-md mt-10" />{" "}
        {/* Hızlı bağlantılar için placeholder */}
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto px-4 py-8 text-center text-red-500 dark:text-red-400">
        <div className="flex items-center justify-center mb-10">
          {" "}
          {/* Başlık için esnek kapsayıcı */}
          <LayoutDashboard className="h-10 w-10 text-gray-900 dark:text-white mr-4" />{" "}
          {/* Logo */}
        ...
        <p>
          {t("error_loading_dashboard_stats")}: {error.message}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md mt-10">
        ...
        <div className="h-64">
          {" "}
          {/* Grafiğin yüksekliğini ayarlayın */}
